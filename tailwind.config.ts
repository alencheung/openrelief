  ...
  theme: {
    extend: {
      colors: {
        ...
        emergency: {
          fire: 'rgb(var(--emergency-fire))',
          medical: 'rgb(var(--emergency-medical))',
          security: 'rgb(var(--emergency-security))',
          natural: 'rgb(var(--emergency-natural))',
          infrastructure: 'rgb(var(--emergency-infrastructure))',
        },
        // Trust score colors
        trust: {
          high: 'rgb(var(--trust-high))',
          medium: 'rgb(var(--trust-medium))',
