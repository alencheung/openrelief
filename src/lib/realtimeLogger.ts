...
class RealtimeLogger {
    ...
    private log(
        ...
        if (context) {
            ...
            if (context.table !== undefined) contextObj.table = context.table
            if (context.eventId !== undefined) contextObj.eventId = context.eventId
            if (context.userId !== undefined) contextObj.userId = context.userId
            if (context.subscriptionId !== undefined) contextObj.subscriptionId = context.subscriptionId
            if (context.retryCount !== undefined) contextObj.retryCount = context.retryCount
            if (context.networkStatus !== undefined) contextObj.networkStatus = context.networkStatus
            if (context.connectionStatus !== undefined) contextObj.connectionStatus = context.connectionStatus
