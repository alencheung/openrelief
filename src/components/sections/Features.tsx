...
import { Flame, Heart, Shield, Smartphone, Map, Users, Bell, Globe, Lock } from 'lucide-react'
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isMobile ? 'py-16' : isTablet ? 'py-20' : 'py-24 sm:py-32'
      )}
    >
      <div className="text-center">
        <h2
          className={cn(
            ...
            isMobile ? 'text-2xl' : isTablet ? 'text-3xl' : 'text-3xl sm:text-4xl'
          )}
        >
          ...
          {features.map(feature => (
            <div key={feature.name} className="flex flex-col">
              <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900">
                <div
                  className={`flex h-10 w-10 items-center justify-center rounded-lg ${feature.color} bg-opacity-10`}
                >
        ...
        <div className="relative mx-auto max-w-2xl">
          ...
          <div
            className={cn(
              ...
              isMobile
                ? 'mt-8 flex-col gap-3 w-full px-4'
                : isTablet
                  ? 'mt-9 gap-x-4'
                  : 'mt-10 gap-x-6'
            )}
      ...
      <div className={cn('text-center', isMobile ? 'mt-20' : isTablet ? 'mt-24' : 'mt-32')}>
        <h2
          className={cn(
            'font-bold tracking-tight text-gray-900',
            isMobile ? 'text-2xl' : isTablet ? 'text-3xl' : 'text-3xl sm:text-4xl'
      ...
      <div
        className={cn(
          ...
          isMobile
            ? 'mt-12 max-w-lg grid-cols-2'
            : isTablet
              ? 'mt-14 max-w-xl grid-cols-2'
              : 'mt-16 max-w-2xl grid-cols-2 lg:grid-cols-4'
        )}
      >
        <div className="flex flex-col items-center">
          <Users className="h-12 w-12 text-gray-600" />
          <div className="mt-4 text-3xl font-bold leading-9 text-gray-900">50K+</div>
          <div className="mt-2 text-base leading-7 text-gray-600">Active Users</div>
        </div>
        <div className="flex flex-col items-center">
          <Globe className="h-12 w-12 text-gray-600" />
          <div className="mt-4 text-3xl font-bold leading-9 text-gray-900">120+</div>
          <div className="mt-2 text-base leading-7 text-gray-600">Countries</div>
        </div>
        <div className="flex flex-col items-center">
          <Heart className="h-12 w-12 text-gray-600" />
          <div className="mt-4 text-3xl font-bold leading-9 text-gray-900">10K+</div>
          <div className="mt-2 text-base leading-7 text-gray-600">Lives Impacted</div>
        </div>
        <div className="flex flex-col items-center">
          <Shield className="h-12 w-12 text-gray-600" />
          <div className="mt-4 text-3xl font-bold leading-9 text-gray-900">99.9%</div>
          <div className="mt-2 text-base leading-7 text-gray-600">Uptime</div>
        </div>
      </div>
    </div>
  )
