...
describe('SpatialInformationOverlay', () => {
  ...
  it('displays bearing', () => {
    ...
    expect(screen.getByText('45° NE')).toBeInTheDocument()
  })
  ...
  it('formats distance over 1km in metric', () => {
    ...
    renderWithProviders(
      <SpatialInformationOverlay {...defaultProps} spatialInfo={spatialInfo} unitSystem="metric" />
    )
  ...
  it('shows show button when overlay is hidden', () => {
    ...
    // Initially visible
    expect(
      screen.queryByRole('button', { name: /show spatial information/i })
  ...
  it('shows interactive controls when enabled', () => {
    ...
    expect(
      screen.getByRole('button', { name: /spatial information settings/i })
    ).toBeInTheDocument()
  })
  ...
  it('hides interactive controls when disabled', () => {
    ...
    expect(
      screen.queryByRole('button', { name: /refresh spatial information/i })
    ).not.toBeInTheDocument()
    expect(
      screen.queryByRole('button', { name: /spatial information settings/i })
    ).not.toBeInTheDocument()
  })
  ...
  it('passes props to underlying div', () => {
    renderWithProviders(
      <SpatialInformationOverlay {...defaultProps} data-testid="custom-overlay" />
    )
  ...
  it('handles missing spatial info properties', () => {
    ...
    renderWithProviders(
      <SpatialInformationOverlay {...defaultProps} spatialInfo={emptySpatialInfo} />
    )
  ...
  it('handles undefined spatial info properties', () => {
    ...
    renderWithProviders(
      <SpatialInformationOverlay {...defaultProps} spatialInfo={undefinedSpatialInfo} />
    )
  ...
  it('handles zero values', () => {
    ...
    renderWithProviders(
      <SpatialInformationOverlay {...defaultProps} spatialInfo={zeroSpatialInfo} />
    )
