    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Sign in to OpenRelief</h2>
          <p className="mt-2 text-sm text-gray-600">Join the emergency coordination network</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-600">
          OpenRelief is a free, open-source emergency coordination platform.
        </p>
      </div>
    </div>
  )
